...
class Mortgage extends Asset {
    ...
    public void setMortgageeName(String n) {
        mortgageeName = n;
    }
    ...
    public String getDateMortgageIssued() {
        return dateMortgageIssued;
    }

    public void setDateMortgageIssued(String d) {
        dateMortgageIssued = d;
    }

    public float getCurrentWeeklyIncome() {
        return currentWeeklyIncome;
    }

    public void setCurrentWeeklyIncome(float c) {
        currentWeeklyIncome = c;
    }

    public String getWeeklyIncomeUpdated() {
        return weeklyIncomeUpdated;
    }

    public void setWeeklyIncomeUpdated(String w) {
        weeklyIncomeUpdated = w;
    }

    public float getAnnualPropertyTax() {
        return annualPropertyTax;
    }

    public void setAnnualPropertyTax(float p) {
        annualPropertyTax = p;
    }

    public float getAnnualInsurancePremium() {
        return annualInsurancePremium;
    }

    public void setAnnualInsurancePremium(float a) {
        annualInsurancePremium = a;
    }
    ...
    public void setMortgageBalance(float m) {
        mortgageBalance = m;
    }
